        ...
        <div className="border-t border-border/50 pt-8 mb-8">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-card/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-border/50 flex items-center gap-2">
                <svg viewBox="0 0 24 24" className="w-8 h-5" fill="currentColor">
                  <path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.437-.983 5.05-4.349 6.797-8.647 6.797H9.603c-.564 0-1.04.413-1.128.967l-.033.22-1.04 6.59-.025.164a.355.355 0 0 1-.3.065z" fill="#003087"/>
                </svg>
