...
switch ($action) {
  ...
  case 'seed_rewards':
    ...
    // PREMIUM TIER - 30 days of premium rewards (30M Zen total, progressive)
    // Zen distribution: Day 1-5: 500k, Day 6-10: 700k, Day 11-15: 900k, Day 16-20: 1.1M, Day 21-25: 1.3M, Day 26-30: 1.5M = 30M
    $premiumRewards = array(
      //  day, name,                 item_id, qty, coins,     zen,      exp,     rarity,      icon
      array(1,  'Daily Coins',        -2, 1, 1000000,  500000,   0,      'common',    'COIN'),
      array(2,  'Zen Spark',          -1, 1, 0,        500000,   0,      'common',    'BOLT'),
      array(3,  'EXP Boost',          -3, 1, 0,        500000,   50000,  'common',    'FIRE'),
      array(4,  'Coin Chest',         -2, 1, 2000000,  500000,   0,      'uncommon',  'COIN'),
      array(5,  'Lucky Spin',         -4, 1, 0,        500000,   0,      'uncommon',  'DICE'),
      array(6,  'Zen Flow',           -1, 1, 0,        700000,   0,      'common',    'BOLT'),
      array(7,  'Weekly Bonus',       -2, 1, 3000000,  700000,   50000,  'rare',      'TROPHY'),
      array(8,  'EXP Surge',          -3, 1, 0,        700000,   100000, 'uncommon',  'FIRE'),
      array(9,  'Coin Rain',          -2, 1, 2500000,  700000,   0,      'uncommon',  'COIN'),
      array(10, 'Zen Chest',          -1, 1, 0,        700000,   0,      'rare',      'GEM'),
      array(11, 'Lucky Spins x2',     -4, 2, 0,        900000,   0,      'rare',      'DICE'),
      array(12, 'Gold Coins',         -2, 1, 5000000,  900000,   0,      'rare',      'GOLD'),
      array(13, 'Zen Surge',          -1, 1, 0,        900000,   0,      'uncommon',  'BOLT'),
      array(14, 'Bi-Weekly Bonus',    -2, 1, 7000000,  900000,   100000, 'epic',      'TROPHY'),
      array(15, 'Zen Blessing',       -1, 1, 0,        900000,   0,      'rare',      'GEM'),
      array(16, 'Coin Vault',         -2, 1, 6000000,  1100000,  0,      'rare',      'COIN'),
      array(17, 'Zen Vault',          -1, 1, 0,        1100000,  0,      'rare',      'GEM'),
      array(18, 'Lucky Spins x3',     -4, 3, 0,        1100000,  0,      'epic',      'DICE'),
      array(19, 'Mega Coins',         -2, 1, 8000000,  1100000,  0,      'epic',      'GOLD'),
      array(20, 'Zen Mega',           -1, 1, 0,        1100000,  0,      'epic',      'SPARKLE'),
      array(21, 'Triple Reward',      -2, 1, 10000000, 1300000,  150000, 'epic',      'STAR'),
      array(22, 'EXP Legendary',      -3, 1, 0,        1300000,  300000, 'epic',      'FIRE'),
      array(23, 'Coin Jackpot',       -2, 1, 12000000, 1300000,  0,      'epic',      'TROPHY'),
      array(24, 'Zen Jackpot',        -1, 1, 0,        1300000,  0,      'epic',      'ORB'),
      array(25, 'Lucky Spins x5',     -4, 5, 0,        1300000,  0,      'legendary', 'DICE'),
      array(26, 'Mega Vault',         -2, 1, 15000000, 1500000,  0,      'legendary', 'GOLD'),
      array(27, 'Zen Fortune',        -1, 1, 0,        1500000,  0,      'legendary', 'GEM'),
      array(28, 'Grand Reward',       -2, 1, 20000000, 1500000,  200000, 'legendary', 'CROWN'),
      array(29, 'Lucky Spins x7',     -4, 7, 0,        1500000,  0,      'legendary', 'DICE'),
      array(30, 'Ultimate Reward',    -2, 1, 25000000, 1500000,  400000, 'legendary', 'CROWN'),
    );
