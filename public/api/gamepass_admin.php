...
switch ($action) {
  ...
  case 'seed_rewards':
    ...
    $premiumRewards = array(
      //  day, name,                 item_id, qty, coins, zen,      exp, rarity,      icon
      array(1,  'Zen Drop',           -1, 1, 0, 500000,   0, 'common',    'BOLT'),
      array(2,  'Zen Drop',           -1, 1, 0, 500000,   0, 'common',    'BOLT'),
      array(3,  'Zen Drop',           -1, 1, 0, 500000,   0, 'common',    'BOLT'),
      array(4,  'Zen Drop',           -1, 1, 0, 500000,   0, 'common',    'BOLT'),
      array(5,  'Zen Drop',           -1, 1, 0, 500000,   0, 'common',    'BOLT'),
      array(6,  'Zen Flow',           -1, 1, 0, 700000,   0, 'uncommon',  'GEM'),
      array(7,  'Zen Flow',           -1, 1, 0, 700000,   0, 'uncommon',  'GEM'),
      array(8,  'Zen Flow',           -1, 1, 0, 700000,   0, 'uncommon',  'GEM'),
      array(9,  'Zen Flow',           -1, 1, 0, 700000,   0, 'uncommon',  'GEM'),
      array(10, 'Zen Flow',           -1, 1, 0, 700000,   0, 'uncommon',  'GEM'),
      array(11, 'Zen Surge',          -1, 1, 0, 900000,   0, 'rare',      'SPARKLE'),
      array(12, 'Zen Surge',          -1, 1, 0, 900000,   0, 'rare',      'SPARKLE'),
      array(13, 'Zen Surge',          -1, 1, 0, 900000,   0, 'rare',      'SPARKLE'),
      array(14, 'Zen Surge',          -1, 1, 0, 900000,   0, 'rare',      'SPARKLE'),
      array(15, 'Zen Surge',          -1, 1, 0, 900000,   0, 'rare',      'SPARKLE'),
      array(16, 'Zen Vault',          -1, 1, 0, 1100000,  0, 'epic',      'ORB'),
      array(17, 'Zen Vault',          -1, 1, 0, 1100000,  0, 'epic',      'ORB'),
      array(18, 'Zen Vault',          -1, 1, 0, 1100000,  0, 'epic',      'ORB'),
      array(19, 'Zen Vault',          -1, 1, 0, 1100000,  0, 'epic',      'ORB'),
      array(20, 'Zen Vault',          -1, 1, 0, 1100000,  0, 'epic',      'ORB'),
      array(21, 'Zen Fortune',        -1, 1, 0, 1300000,  0, 'legendary', 'CROWN'),
      array(22, 'Zen Fortune',        -1, 1, 0, 1300000,  0, 'legendary', 'CROWN'),
      array(23, 'Zen Fortune',        -1, 1, 0, 1300000,  0, 'legendary', 'CROWN'),
      array(24, 'Zen Fortune',        -1, 1, 0, 1300000,  0, 'legendary', 'CROWN'),
      array(25, 'Zen Fortune',        -1, 1, 0, 1300000,  0, 'legendary', 'CROWN'),
      array(26, 'Zen Jackpot',        -1, 1, 0, 1500000,  0, 'legendary', 'CROWN'),
      array(27, 'Zen Jackpot',        -1, 1, 0, 1500000,  0, 'legendary', 'CROWN'),
      array(28, 'Zen Jackpot',        -1, 1, 0, 1500000,  0, 'legendary', 'CROWN'),
      array(29, 'Zen Jackpot',        -1, 1, 0, 1500000,  0, 'legendary', 'CROWN'),
      array(30, 'Zen Jackpot',        -1, 1, 0, 1500000,  0, 'legendary', 'CROWN'),
    );
